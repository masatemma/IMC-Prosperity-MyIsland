...
class Trader:
    ...
    PORTFOLIO_TRADE_AMOUNT = {'AMETHYSTS': 2, 'STARFRUIT': 2, 'ORCHIDS': 0, 'CHOCOLATE': 0, 'STRAWBERRIES': 0, 'ROSES': 2, 'GIFT_BASKET': 5}  # Not used for Starfruit
    ...
    def compute_orders_lr(self, past_trades: PastData, product: str):
